...
namespace PCB
{
    public partial class frmProduktNazev : frmBaseSeznam
    {
        public frmProduktNazev()
        {
            InitializeComponent();
        }
        ...
        public override void LoadData(System.Data.Entity.Core.Objects.DataClasses.EntityObject entity)
        {
            ...
            objednavkapolozkaBindingSource.DataSource = DBContext.objednavka_polozkas.Where(i=>i.produkt!=null);
        }
